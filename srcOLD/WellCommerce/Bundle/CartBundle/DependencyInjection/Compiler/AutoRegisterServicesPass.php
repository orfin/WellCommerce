...
use WellCommerce\Bundle\CartBundle\DependencyInjection\WellCommerceCartExtension;
...
class AutoRegisterServicesPass extends AbstractAutoRegisterServicesPass
{
    ...
    {
        return $container->getParameter(WellCommerceCartExtension::EXTENSION_NAME);
    }
}
