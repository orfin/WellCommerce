 ...
 */
class Version20141109125856 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE routes CHANGE locale locale VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE routes CHANGE locale locale VARCHAR(12) DEFAULT NULL COLLATE utf8_unicode_ci');
