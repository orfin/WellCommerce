 ...
 */
class Version20141226143039 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_translation DROP route_id, DROP slug');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_translation ADD route_id INT DEFAULT NULL, ADD slug VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
