...
class LoadShopData extends AbstractDataFixture
{
    ...
    {
        /**
         * @var $theme       \WellCommerce\LayoutBundle\Entity\ThemeInterface
         * @var $company     \WellCommerce\CommonBundle\Entity\CompanyInterface
         * @var $orderStatus \WellCommerce\SalesBundle\Entity\OrderStatusInterface
         */
