...
namespace WellCommerce\CommonBundle\Resolver\Front;

use WellCommerce\CommonBundle\Resolver\AbstractShopResolver;
use WellCommerce\CommonBundle\Resolver\ShopResolverInterface;
