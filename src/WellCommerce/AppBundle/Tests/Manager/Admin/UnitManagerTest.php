...
class UnitManagerTest extends AbstractAdminManagerTestCase
{
    ...
    {
        return 'WellCommerce\AppBundle\Manager\Admin\UnitManager';
    }

    protected function getFormBuilderClassName()
    {
        return 'WellCommerce\AppBundle\Form\Admin\UnitFormBuilder';
    }

    protected function getDataGridClassName()
    {
        return 'WellCommerce\AppBundle\DataGrid\UnitDataGrid';
    }

    protected function getRepositoryInterfaceName()
    {
        return 'WellCommerce\AppBundle\Repository\UnitRepositoryInterface';
    }
}
