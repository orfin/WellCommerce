...
class TaxManagerTest extends AbstractAdminManagerTestCase
{
    ...
    {
        return 'WellCommerce\AppBundle\Manager\Admin\TaxManager';
    }

    protected function getFormBuilderClassName()
    {
        return 'WellCommerce\AppBundle\Form\Admin\TaxFormBuilder';
    }

    protected function getDataGridClassName()
    {
        return 'WellCommerce\AppBundle\DataGrid\TaxDataGrid';
    }

    protected function getRepositoryInterfaceName()
    {
        return 'WellCommerce\AppBundle\Repository\TaxRepositoryInterface';
    }
}
