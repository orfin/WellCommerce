...
use WellCommerce\AppBundle\Entity\ClientAwareInterface;
use WellCommerce\AppBundle\Entity\ClientBillingAddressInterface;
use WellCommerce\AppBundle\Entity\ClientContactDetailsInterface;
use WellCommerce\AppBundle\Entity\ClientShippingAddressInterface;
use WellCommerce\AppBundle\Entity\ShopAwareInterface;
use WellCommerce\AppBundle\Entity\TimestampableInterface;
use WellCommerce\AppBundle\Entity\CouponAwareInterface;
use WellCommerce\AppBundle\Calculator\ShippingCalculatorSubjectInterface;
use WellCommerce\AppBundle\Visitor\CartVisitorInterface;
