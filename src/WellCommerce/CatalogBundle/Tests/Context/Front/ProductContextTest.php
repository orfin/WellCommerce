...
namespace WellCommerce\CatalogBundle\Tests\Context\Front;
...
class ProductContextTest extends AbstractTestCase
{
    public function testContextReturnsValidData()
    {
        ...
        $this->assertInstanceOf('WellCommerce\CatalogBundle\Entity\ProductInterface', $context->getCurrentProduct());
