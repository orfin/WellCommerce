...
class CategoryManagerTest extends AbstractAdminManagerTestCase
{
    ...
    {
        return 'WellCommerce\CatalogBundle\Manager\Admin\CategoryManager';
    }

    protected function getFormBuilderClassName()
    {
        return 'WellCommerce\CatalogBundle\Form\Admin\CategoryFormBuilder';
    }

    protected function getDataGridClassName()
    {
        return 'WellCommerce\CatalogBundle\DataGrid\CategoryDataGrid';
    }

    protected function getRepositoryInterfaceName()
    {
        return 'WellCommerce\CatalogBundle\Repository\CategoryRepositoryInterface';
    }
