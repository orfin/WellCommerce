...
namespace WellCommerce\CoreBundle\Component\Form;
...
use WellCommerce\CoreBundle\Component\Form\Handler\FormHandlerInterface;
use WellCommerce\CoreBundle\Component\Form\Resolver\FormResolverFactoryInterface;
...
abstract class AbstractFormBuilder extends AbstractContainerAware implements FormBuilderInterface
{
    ...
    {
        /** @var $transformer \WellCommerce\CoreBundle\Component\Form\DataTransformer\RepositoryAwareDataTransformerInterface */
