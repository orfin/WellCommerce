...
class LoadProducerData extends AbstractDataFixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach (self::$samples as $name) {
            ...
            $producer->translate($this->container->getParameter('locale'))->setName($name);
            $producer->translate($this->container->getParameter('locale'))->setSlug(Sluggable::makeSlug($name));
