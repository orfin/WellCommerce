 ...
 */
namespace WellCommerce\Bundle\ProducerBundle\EventListener;
 ...
 *
 * @package WellCommerce\Producer\EventListener
 * @author  Adam Piotrowski <adam@wellcommerce.org>
 */
class ProducerListener implements EventSubscriberInterface
{
    /**
    ...
    public function onAdminMenuInitEvent(AdminMenuEvent $event)
    {
        ...
        $builder->add(new AdminMenuItem([
            'id'         => 'producer',
            'name'       => $this->translator->trans('menu.catalog.producer'),
            'link'       => $this->router->generate('admin.producer.index'),
            'path'       => '[menu][catalog][producer]',
            'sort_order' => 30
        ]));
    }
