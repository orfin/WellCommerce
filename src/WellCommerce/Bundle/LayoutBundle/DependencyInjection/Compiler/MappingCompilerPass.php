...
use WellCommerce\Bundle\LayoutBundle\DependencyInjection\WellCommerceLayoutExtension;
...
class MappingCompilerPass extends AbstractMappingCompilerPass
{
    ...
    {
        return $container->getParameter(WellCommerceLayoutExtension::EXTENSION_NAME);
    }
}
