...
namespace WellCommerce\Bundle\SalesBundle\Tests\Context\Front;
...
class CartContextTest extends AbstractTestCase
{
    public function testContextReturnsValidData()
    {
        ...
        $this->assertInstanceOf('WellCommerce\Bundle\SalesBundle\Entity\CartInterface', $context->getCurrentCart());
