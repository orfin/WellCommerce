...
class CategoryManagerTest extends AbstractAdminManagerTestCase
{
    ...
    {
        return 'WellCommerce\Bundle\CategoryBundle\Manager\Admin\CategoryManager';
    }

    protected function getFormBuilderClassName()
    {
        return 'WellCommerce\Bundle\CategoryBundle\Form\Admin\CategoryFormBuilder';
    }

    protected function getDataGridClassName()
    {
        return 'WellCommerce\Bundle\CategoryBundle\DataGrid\CategoryDataGrid';
    }
