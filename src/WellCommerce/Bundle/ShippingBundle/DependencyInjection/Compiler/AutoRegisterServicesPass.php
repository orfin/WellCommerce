...
use WellCommerce\Bundle\ShippingBundle\DependencyInjection\WellCommerceShippingExtension;
...
class AutoRegisterServicesPass extends AbstractAutoRegisterServicesPass
{
    ...
    {
        return $container->getParameter(WellCommerceShippingExtension::EXTENSION_NAME);
    }
}
