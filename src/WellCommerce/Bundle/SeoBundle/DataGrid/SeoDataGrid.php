 ...
 */
namespace WellCommerce\Bundle\SeoBundle\DataGrid;
 ...
 */
class SeoDataGrid extends AbstractDataGrid implements DataGridInterface
{
    /**
     * {@inheritdoc}
     */
    public function configureColumns(ColumnCollection $collection)
    {
        $collection->add(new Column([
            'id'         => 'id',
            'caption'    => $this->trans('seo.id.label'),
            'sorting'    => new Sorting([
