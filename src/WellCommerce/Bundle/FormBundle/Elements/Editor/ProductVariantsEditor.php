...
class ProductVariantsEditor extends AbstractField implements ElementInterface
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setAllowedTypes([
            'allow_generate'     => 'bool',
            'availability_field' => 'WellCommerce\Bundle\FormBundle\Elements\ElementInterface',
            'vat_field'          => 'WellCommerce\Bundle\FormBundle\Elements\ElementInterface',
            'vat_values'         => 'array',
            'photos'             => 'array',
            'availability'       => 'array',
            'price_field'        => 'WellCommerce\Bundle\FormBundle\Elements\ElementInterface',
            'category_field'     => 'WellCommerce\Bundle\FormBundle\Elements\ElementInterface',
        ]);
