...
class DictionaryManager extends AbstractAdminManager
{
    ...
    /**
     * @var array|\WellCommerce\Bundle\CommonBundle\Entity\Locale[]
     */
    protected $locales;
    ...
    {
        $em           = $this->getDoctrineHelper()->getEntityManager();
        $repository   = $em->getRepository('WellCommerceCommonBundle:Dictionary');
    ...
    protected function mergeAndSaveTranslations()
    {
        ...
        $this->getDoctrineHelper()->truncateTable('WellCommerceCommonBundle:Dictionary');
