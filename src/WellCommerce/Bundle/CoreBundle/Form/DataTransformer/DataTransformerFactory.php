...
use WellCommerce\Bundle\CoreBundle\Exception\MissingFormDataTransformerException;
...
class DataTransformerFactory extends AbstractContainerAware
{
     ...
     * @param string $alias
     *
     * @return \WellCommerce\Bundle\FormBundle\DataTransformer\DataTransformerInterface
     */
