 ...
 *
 * @package WellCommerce\Availability\EventListener
...
class AvailabilityListener implements EventSubscriberInterface
{
    ...
    public function onAdminMenuInitEvent(AdminMenuEvent $event)
    {
        ...
        $builder->add(new AdminMenuItem([
            'id'         => 'availability',
            'name'       => $this->translator->trans('menu.catalog.availability'),
            'link'       => $this->router->generate('admin.availability.index'),
            'path'       => '[menu][catalog][availability]',
            'sort_order' => 30
        ]));
    }
