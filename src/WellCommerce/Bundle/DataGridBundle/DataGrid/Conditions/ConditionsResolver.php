...
namespace WellCommerce\Bundle\DataGridBundle\DataGrid\Conditions;

use WellCommerce\Bundle\DataSetBundle\DataSet\Column\ColumnCollection;
use WellCommerce\Bundle\DataSetBundle\DataSet\Conditions\Condition\Eq;
use WellCommerce\Bundle\DataSetBundle\DataSet\Conditions\Condition\Gte;
use WellCommerce\Bundle\DataSetBundle\DataSet\Conditions\Condition\In;
use WellCommerce\Bundle\DataSetBundle\DataSet\Conditions\Condition\Like;
use WellCommerce\Bundle\DataSetBundle\DataSet\Conditions\Condition\Lte;
use WellCommerce\Bundle\DataSetBundle\DataSet\Conditions\Condition\Neq;
use WellCommerce\Bundle\DataSetBundle\DataSet\Conditions\ConditionsCollection;

/**
 * Class ConditionsResolver
 *
 * @package WellCommerce\Bundle\DataGridBundle\DataGrid\Conditions
