...
class CartController extends AbstractFrontController
{
    ...
    public function addAction(ProductInterface $product, ProductAttributeInterface $attribute = null, $quantity = 1)
    {
        ...
        $basketModalContent = $this->renderView('WellCommerceAppBundle:Front/Cart:add.html.twig', [
            'product'         => $product,
            'recommendations' => $recommendations
        ]);

        $cartPreviewContent = $this->renderView('WellCommerceAppBundle:Front/Common:preview.html.twig');
