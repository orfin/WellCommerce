...
namespace WellCommerce\Bundle\TaxBundle\DependencyInjection\Compiler;
...
use WellCommerce\Bundle\TaxBundle\DependencyInjection\WellCommerceTaxExtension;
...
class AutoRegisterServicesPass extends AbstractAutoRegisterServicesPass
{
    ...
    {
        return $container->getParameter(WellCommerceTaxExtension::EXTENSION_NAME);
    }
}
