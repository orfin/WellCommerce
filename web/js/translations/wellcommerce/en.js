(function (Translator) {
    ...
    Translator.add("product_search.heading.index", "Search results", "wellcommerce", "en");
    Translator.add("product_search.label.phrase", "Enter search phrase", "wellcommerce", "en");
