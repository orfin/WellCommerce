 ...
 */
class Category extends AbstractModel implements ModelInterface
{
    ...
    {
        return $this->belongsToMany('WellCommerce\Shop\Model\Shop', 'category_shop', 'category_id', 'shop_id');
    }
    ...
    {
        return $this->hasOne('WellCommerce\Category\Model\CategoryTranslation');
    }
    ...
    {
        return $this->hasMany('WellCommerce\Category\Model\CategoryTranslation');
    }
    ...
    {
        return $this->belongsTo('WellCommerce\File\Model\File');
    }
