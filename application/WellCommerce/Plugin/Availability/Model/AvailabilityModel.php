 ...
 */
class AvailabilityModel extends AbstractModel implements TranslatableModelInterface
{
    /**
    ...
    {
        return $this->hasMany('WellCommerce\Plugin\Availability\Model\AvailabilityTranslationModel');
    }
}
