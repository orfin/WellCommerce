 ...
 */
namespace WellCommerce\Plugin\Producer\EventListener;
...
class ProducerListener implements EventSubscriberInterface
{
    ...
    public function onAdminMenuInitEvent(AdminMenuEvent $event)
    {
        ...
        $builder->add(new AdminMenuItem([
            'id'         => 'producer',
            'name'       => $this->container->get('translation')->trans('Producers'),
            'link'       => $this->container->get('router')->generate('admin.producer.index'),
