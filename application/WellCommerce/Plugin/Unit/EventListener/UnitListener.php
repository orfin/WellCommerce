 ...
 */
namespace WellCommerce\Plugin\Unit\EventListener;
...
class UnitListener implements EventSubscriberInterface
{
    ...
    public function onAdminMenuInitEvent(AdminMenuEvent $event)
    {
        ...
        $builder->add(new AdminMenuItem([
            'id'         => 'unit',
            'name'       => $this->container->get('translation')->trans('Units'),
            'link'       => $this->container->get('router')->generate('admin.unit.index'),
